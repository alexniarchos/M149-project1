...
@Component
class DataToGarbageCartsService(
  ...
  companion object {
    ...
    private const val NUMBER_OF_CARTS_DELIVERED = 5
  ...
  @Transactional
  fun convertAndSave(line: Array<String?>): GarbageCarts {
    ...
    return GarbageCarts(
      event.id!!,
      line[NUMBER_OF_CARTS_DELIVERED]?.toLong()
    )
  }
  ...
  fun convertAndSaveAsDump(line: Array<String?>): Dump =
    dataToDumpService.convertAndSave(
      ...
      wardsPosition = WARDS,
      ssaPosition = SSA,
      numberDeliveredPosition = NUMBER_OF_CARTS_DELIVERED,
